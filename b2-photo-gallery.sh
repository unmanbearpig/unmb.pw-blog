...
show_help() {
    echo "b2-photo-gallery - Upload photos to Backblaze B2 and generate Jekyll gallery pages"
    echo
    echo "Usage:"
    echo "  ./b2-photo-gallery.sh [OPTIONS] <photo-directory>"
    echo
    echo "Options:"
    ...
    echo
    echo "Examples:"
    echo "  ./b2-photo-gallery.sh /path/to/photos"
    echo "  ./b2-photo-gallery.sh -t \"My Gallery\" -d 2024-03-20 /path/to/photos"
    echo "  ./b2-photo-gallery.sh --dry-run /path/to/photos"
    echo
    echo "Environment:"
...
python3 "$SCRIPT_DIR/b2-photo-gallery.py" "${CMD_ARGS[@]}" 